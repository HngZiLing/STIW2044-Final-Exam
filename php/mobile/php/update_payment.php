...
$signed= hash_hmac('sha256', $signing, 'S-AaVSdP4AHzjQLnDP7NwZPg');
...
function printTable($receiptid,$name,$email,$amount,$paidstatus,$message){
   echo "
        ...
        <h4 style='font-family: Franklin Gothic Medium, impact, cursive, sans-serif;font-size:20px'>Thank you for your payment</h4>
        <p style='font-family: Bahnschrift, arial, sans-serif;font-size:14px'>The following is your receipt</p></div>
        ...
        <div class='w3-container w3-round w3-block w3-green' style='font-family: Bahnschrift, arial, sans-serif;border-radius:20px;'>$message</div>
        </div>
        <div class='container' style='height:10px'></div>
        </body></html> 
        ";
